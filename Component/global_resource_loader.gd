...
@export_dir var heal_item_folder : Array[String]
...
var heal_item_cache : Dictionary[String, Resource] = {}
...
func _ready() -> void:
	...
	for folder in heal_item_folder:
		_file_load(folder, heal_item_cache)
