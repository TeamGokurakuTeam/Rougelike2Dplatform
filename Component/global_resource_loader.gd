...
@export_dir var obelisk_folder : Array[String]
...
var obelisk_cache : Dictionary[String, ObeliskResource] = {}
...
func _file_obelisk_load(folder_path : String, res_cache : Dictionary) -> void:
	var folder : DirAccess = DirAccess.open(folder_path)
